...
<div class="container-fluid sticky-top header shadow">
    <div class="row collapse show no-gutters d-flex h-100 position-relative">
        <div class="col-3 px-0 w-sidebar navbar-collapse collapse d-none d-md-flex">
            <!-- spacer col -->
            <a href="#" class="navbar-brand">{{ auth()->guard('parent')->user()->schoolData->school_short_name }}</a>
        </div>
                        ...
                        <li class="nav-item dropdown"></li>
                            <li class="nav-item dropdown">
                                <a id="navbarDropdown" class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                                    {{ strlen(auth()->guard('parent')->user()->first_name) > 20 ? substr(auth()->guard('parent')->user()->first_name, 0, 20) . "..." : auth()->guard('parent')->user()->first_name; }}
                                </a>
