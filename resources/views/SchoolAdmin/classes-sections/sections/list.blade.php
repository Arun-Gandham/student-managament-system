...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            <table id="sections" class="display">
                <thead>
                </thead>
                <tbody>
                </tbody>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('#sections').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{!! route('schooladmin.class-sections.sections.datatable.list') !!}",
                columns: [{
                        "title": "S.No",
                        "data": null,
                        "orderable": false,
                ...
                buttons: [{
                        text: '<i class="fa fa-plus" aria-hidden="true"></i> New Section',
                        "className": 'export_btn',
                        action: function(e, dt, node, config) {
                            window.location.replace("{{ route('schooladmin.class-sections.section.add') }}");
                        }
                    },
                    {
                        "extend": "pdf",
