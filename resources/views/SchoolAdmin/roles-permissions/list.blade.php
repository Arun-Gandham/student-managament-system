...
<script type="text/javascript">
    $(document).ready(function() {
        $('#myTable').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: "{!! route('schooladmin.roles-permissions.roles.list.datatable') !!}",
            columns: [
                {
                    "title": "S.No",
                    "data": null,
                ...
                { data: 'description', name: 'description', title: 'Descrption'},
            ...
            buttons: [
                {
                    text: '<i class="fa fa-plus" aria-hidden="true"></i> New Role',
                    "className": 'export_btn',
                    action: function ( e, dt, node, config ) {
                        window.location.replace("{{ route('schooladmin.roles-permissions.roles.add') }}");
                    }
                },
                {
                "extend": "pdf",
