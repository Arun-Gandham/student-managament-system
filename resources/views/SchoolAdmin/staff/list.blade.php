...
<script type="text/javascript">
    $(document).ready(function() {
        $('#myTable').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: "{!! route('schooladmin.staff-management.list.datatable') !!}",
            columns: [
                {
                    "title": "S.No",
                    "data": null,
            ...
            buttons: [
                {
                    text: '<i class="fa fa-plus" aria-hidden="true"></i> New Staff',
                    "className": 'export_btn',
                    action: function ( e, dt, node, config ) {
                        window.location.replace("{{ route('schooladmin.staff-management.add') }}");
                    }
                },
                {
                "extend": "pdf",
