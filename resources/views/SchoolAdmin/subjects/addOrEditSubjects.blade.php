    ...
    <div class="row">
        <div class="col-md-3">
            <div class="form-block">
                ...
                <form action="{{ isset($formData) ? route('schooladmin.subject.submit',["id" => $formData->id]) : route('schooladmin.subject.submit') }}" method="POST" id="getSudents"
                    name="getSudents">
                    @csrf
                    <div class="border rounded  block-inner mb-5">
                        @include('components.textInput', [
                            ...
                            'name' => 'subject_name',
                            'required' => true,
                            'value' => isset($formData) ? $formData->subject_name : '',
                        ])
                        <div class="col-md-3">
                    ...
                    <tbody>
                        @foreach ($subjects as $subject)
                            <tr>
                                ...
                                <td>
                                    <a href="{{route('schooladmin.subject.edit',["id" => $subject->id])}}" class="btn btn-xs btn-info"><img src="{{asset("svg/edit.svg")}}" atl="edit"></a>
