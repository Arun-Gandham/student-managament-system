    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $('#myTable').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{!! route('schooladmin.exams.datatable.list') !!}",
                columns: [{
                        "title": "S.No",
                        "data": null,
                        "orderable": false,
                ...
                buttons: [{
                        text: '<i class="fa fa-plus" aria-hidden="true"></i> New Exam',
                        "className": 'export_btn',
                        action: function(e, dt, node, config) {
                            window.location.replace("{{ route('schooladmin.exams.schedule') }}");
                        }
                    },
                    {
                        "extend": "pdf",
